              ...
              <div className="flex gap-2">
                {!isAccepted ? (
                  ...
                  <button
                    ...
                    disabled={isUpdating}
                    className={`flex-1 px-3 py-2 md:py-1.5 min-h-[40px] md:min-h-fit rounded-lg font-bold text-xs transition-all duration-200 flex items-center justify-center gap-1 ${
                      isUpdating
                        ? darkMode
                  ...
                  <button
                    disabled
                    className={`flex-1 px-3 py-2 md:py-1.5 min-h-[40px] md:min-h-fit rounded-lg font-bold text-xs cursor-not-allowed flex items-center justify-center gap-1 ${
                      darkMode
                ...
                <>
                  <div className={`flex-1 relative ${isUpdating ? "opacity-50 pointer-events-none" : ""}`}>
                    <select
                      ...
                      className={`w-full h-full min-h-[40px] md:min-h-fit px-2 py-1.5 rounded-lg font-bold text-xs transition-all duration-200 appearance-none text-center cursor-pointer ${
