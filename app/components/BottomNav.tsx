    ...
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-[#014167] border-t border-[#E55143]/30 shadow-2xl z-50 backdrop-blur-sm">
      <div className="flex justify-around items-center h-16 px-2">
        ...
        >
          <svg
            className={`w-6 h-6 transition-colors ${
              pathname === "/" ? "text-[#E55143]" : "text-[#FDFCDF] group-hover:text-[#E55143]"
            }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        <Link
          href="/submit"
          className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-all group ${
            pathname === "/submit" ? "bg-[#699D5D]/30" : "hover:bg-[#699D5D]/20"
          }`}
        >
          <div className="relative">
            <svg
              className={`w-6 h-6 transition-transform ${
                pathname === "/submit" ? "text-[#699D5D] scale-110" : "text-[#699D5D] group-hover:scale-110"
              }`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          <span
            className={`text-xs font-bold transition-transform ${
              pathname === "/submit" ? "text-[#699D5D] scale-105" : "text-[#699D5D] group-hover:scale-105"
            }`}
          >
            ส่งเคส
          </span>
        ...
        <Link
          href="/completed"
          className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-all group ${
            pathname === "/completed" ? "bg-[#C7CFDA]/30" : "hover:bg-[#C7CFDA]/20"
          }`}
        >
          <svg
            className={`w-6 h-6 transition-colors ${
              pathname === "/completed" ? "text-[#C7CFDA]" : "text-[#FDFCDF] group-hover:text-[#C7CFDA]"
            }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
