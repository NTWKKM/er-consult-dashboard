  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex items-center justify-center p-3 py-6">
      <div className="relative max-w-4xl w-full">
        <div className="bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-600 text-white p-2.5 rounded-xl shadow-xl mb-3 z-10 relative border-2 border-white">
          <div className="flex items-center justify-center gap-2">
            ...
            <div>
              <h1 className="text-lg font-bold">ส่งเคสปรึกษา</h1>
