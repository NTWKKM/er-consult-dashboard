        ...
        <div className="bg-white p-5 md:p-6 rounded-xl shadow-md relative z-0 border border-gray-100">
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="hn" className="flex items-center gap-1.5 text-xs font-bold text-gray-600 mb-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all duration-200 text-sm"
                  placeholder="เช่น 1234567"
                  required
                />
              </div>
              <div>
                <label htmlFor="room" className="flex items-center gap-1.5 text-xs font-bold text-gray-600 mb-2">
                  <svg className="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <label htmlFor="problem" className="flex items-center gap-1.5 text-xs font-bold text-gray-600 mb-2">
                <svg className="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
