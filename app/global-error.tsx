    ...
    <html lang="th" suppressHydrationWarning>
      <body className="font-sans bg-[#014167] dark:bg-gray-900 min-h-screen transition-colors duration-300 flex items-center justify-center p-4">
        <div 
          ...
          aria-live="assertive"
          aria-atomic="true"
          className="max-w-md w-full bg-[#C7CFDA] dark:bg-gray-800 border border-[#E55143]/50 dark:border-[#E55143]/30 rounded-xl shadow-2xl p-6 md:p-8 text-center slide-in"
        >
